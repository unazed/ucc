...
# 19 "src/tokenizer.c" 3 4
 "u" 
# 19 "src/tokenizer.c"
 "\033[0m" ": " "\033[1;" "34m" "verbose: " "\033[0m" "freeing tokenizer: %p" "\n", "src/tokenizer.c", 19, ((void *)((uintptr_t)self & 0xFFFFFFFF)));
...
{
  array_t lexemes; for (size_t i = 0; i < array_length (self->lexer->lexeme_arrays) && (lexemes = array_get (self->lexer->lexeme_arrays, i)); ++i)
...
{
  tkn_t tokenizer = __chk_calloc_impl (__func__, (1), (sizeof (*(tkn_t)
# 39 "src/tokenizer.c" 3 4
                   ((void *)0)
# 39 "src/tokenizer.c"
                   )));
  tokenizer->lexer = lexer;
  fprintf ((
# 41 "src/tokenizer.c" 3 4
 stdout
# 41 "src/tokenizer.c"
 ), "\033[1;" "37m" "%s:%" 
# 41 "src/tokenizer.c" 3 4
 "u" 
# 41 "src/tokenizer.c"
 "\033[0m" ": " "\033[1;" "34m" "verbose: " "\033[0m" "created tokeniser: %p" "\n", "src/tokenizer.c", 41, ((void *)((uintptr_t)tokenizer & 0xFFFFFFFF)));
  return tokenizer;
}
