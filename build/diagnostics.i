...
# 4 "src/diagnostics.c" 2

# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/13/include/stdarg.h" 1 3 4
# 6 "src/diagnostics.c" 2
...
# 9 "src/diagnostics.c" 2




# 12 "src/diagnostics.c"
...
diagn_new (struct compilation_args* comp_args,
           ...
           const char* const path)
{
  diagn_t diagn = __chk_calloc_impl (__func__, (1), (sizeof (*(diagn_t)
# 36 "src/diagnostics.c" 3 4
                 ((void *)0)
# 36 "src/diagnostics.c"
                 )));
...
static 
# 44 "src/diagnostics.c" 3 4
      _Bool

# 45 "src/diagnostics.c"
diagn_is_warn_enabled (diagn_t self, const char* warn_name)
{
  ...
  if (!(0)) { fprintf ((
# 49 "src/diagnostics.c" 3 4
 stderr
# 49 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 49 "src/diagnostics.c" 3 4
 "u" 
# 49 "src/diagnostics.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "\033[1;" "37m" "Assertion failed: " "\033[0m" "%s" "\n", "src/diagnostics.c", 49, "0"); { fprintf ((
# 49 "src/diagnostics.c" 3 4
 stderr
# 49 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 49 "src/diagnostics.c" 3 4
 "u" 
# 49 "src/diagnostics.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "Unknown warning name \"%s\", maybe you spelled it wrong?" "\n", "src/diagnostics.c", 49, warn_name); exit (
# 49 "src/diagnostics.c" 3 4
 1
# 49 "src/diagnostics.c"
 ); }; }
...
{
  if (warn_name_opt != 
# 60 "src/diagnostics.c" 3 4
                      ((void *)0) 
# 60 "src/diagnostics.c"
                           && !diagn_is_warn_enabled (self, warn_name_opt))
    {
      fprintf ((
# 62 "src/diagnostics.c" 3 4
     stdout
# 62 "src/diagnostics.c"
     ), "\033[1;" "37m" "%s:%" 
# 62 "src/diagnostics.c" 3 4
     "u" 
# 62 "src/diagnostics.c"
     "\033[0m" ": " "\033[1;" "34m" "verbose: " "\033[0m" "ignoring warning \"%s\" because it is disabled" "\n", "src/diagnostics.c", 62, warn_name_opt);
      return;
    }
  struct diagnostic* diagn = __chk_calloc_impl (__func__, (1), (sizeof (*diagn)));
  diagn->lexeme = lexeme;
  diagn->type = type;

  va_list args;
  
# 70 "src/diagnostics.c" 3 4
 __builtin_va_start(
# 70 "src/diagnostics.c"
 args
# 70 "src/diagnostics.c" 3 4
 ,
# 70 "src/diagnostics.c"
...
# 70 "src/diagnostics.c"
                     ;
  if (!((vasprintf (&diagn->msg, fmt, args) > 0))) { fprintf ((
# 71 "src/diagnostics.c" 3 4
 stderr
# 71 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 71 "src/diagnostics.c" 3 4
 "u" 
# 71 "src/diagnostics.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "\033[1;" "37m" "Assertion failed: " "\033[0m" "%s" "\n", "src/diagnostics.c", 71, "(vasprintf (&diagn->msg, fmt, args) > 0)"); { fprintf ((
# 71 "src/diagnostics.c" 3 4
 stderr
# 71 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 71 "src/diagnostics.c" 3 4
 "u" 
# 71 "src/diagnostics.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "vasprintf() failed" "\n", "src/diagnostics.c", 71); exit (
# 71 "src/diagnostics.c" 3 4
 1
# 71 "src/diagnostics.c"
 ); }; };
  
# 72 "src/diagnostics.c" 3 4
 __builtin_va_end(
# 72 "src/diagnostics.c"
 args
# 72 "src/diagnostics.c" 3 4
 )
# 72 "src/diagnostics.c"
...
diagn_enum_to_string (enum diagn_type type)
{
  ...
  {
    case DiagnosticNote:
      return "\033[1;" "36m" "note:" "\033[0m";
    case DiagnosticWarning:
      return "\033[1;" "36m" "warning:" "\033[0m";
    case DiagnosticError:
...
diagn_line_start_offset (const uint8_t* start, uint64_t stream_offs)
{
  ...
  while (
# 122 "src/diagnostics.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 122 "src/diagnostics.c"
        *(start - length)
# 122 "src/diagnostics.c" 3 4
...
diagn_flush_single (diagn_t self, fptr_t file, struct diagnostic* diagn)
{
  ...
  __extension__ __auto_type line_start_offset = diagn_line_start_offset (
    lexeme_raw, diagn->lexeme->stream_offs);
  __extension__ __auto_type line_no = diagn_lineno (self->src_stream, diagn->lexeme->stream_offs);

  fprintf (file, "%s:%" 
# 146 "src/diagnostics.c" 3 4
                       "l" "u" 
# 146 "src/diagnostics.c"
                              ":%" 
# 146 "src/diagnostics.c" 3 4
                                   "l" "u" 
# 146 "src/diagnostics.c"
  ...
  __extension__ __auto_type length = diagn->lexeme->length;
  fprintf (file, "%*" 
# 150 "src/diagnostics.c" 3 4
                     "l" "u" 
# 150 "src/diagnostics.c"
                            " |  %.*s",
           4, line_no,
  ...
  for (size_t i = 0; i < diagn->lexeme->length; ++i)
  {
    ...
    if (current == '\n')
    {
      if (++rel_line > (3))
      {
        __extension__ __auto_type lines_left = diagn_lineno (lexeme_raw, diagn->lexeme->stream_offs + diagn->lexeme->length)
                          - rel_line;
        if (!lines_left)
          break;
        fprintf (file, "\n%*c |  ", 4, ' ');
        fprintf (file, "(... %" 
# 167 "src/diagnostics.c" 3 4
                               "l" "u" 
# 167 "src/diagnostics.c"
                                      " lines)",
                 lines_left);
        break;
      }
      fprintf (file, "\n%*" 
# 171 "src/diagnostics.c" 3 4
                           "l" "u" 
# 171 "src/diagnostics.c"
                                  " |  ", 4, ++line_no);
      continue;
    }
             ...
             fptr_t file)
{
  uint64_t nr_errors = 0,
           nr_warnings = 0,
           nr_notes = 0;
  struct diagnostic* diagn; for (size_t i = 0; i < array_length (self->diagns) && (diagn = array_get (self->diagns, i)); ++i)
    {
  ...
  fprintf ((
# 194 "src/diagnostics.c" 3 4
 stdout
# 194 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 194 "src/diagnostics.c" 3 4
 "u" 
# 194 "src/diagnostics.c"
 "\033[0m" ": " "\033[0;" "34m" "log: " "\033[0m" "Dumped %" 
# 194 "src/diagnostics.c" 3 4
 "l" "u" 
# 194 "src/diagnostics.c"
 " error(s), %" 
...
# 194 "src/diagnostics.c" 3 4
 "l" "u" 
# 194 "src/diagnostics.c"
 " note(s)" "\n", "src/diagnostics.c", 194, nr_errors, nr_warnings, nr_notes)
                                                ;
  return nr_errors;
}
...
{
  fprintf ((
# 202 "src/diagnostics.c" 3 4
 stdout
# 202 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 202 "src/diagnostics.c" 3 4
 "u" 
# 202 "src/diagnostics.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "\tfreeing diagnostic: %p" "\n", "src/diagnostics.c", 202, ((void *)((uintptr_t)diagn & 0xFFFFFFFF)));
  __chk_free_impl (__func__, diagn->msg);
  __chk_free_impl (__func__, diagn);
}
...
{
  fprintf ((
# 210 "src/diagnostics.c" 3 4
 stdout
# 210 "src/diagnostics.c"
 ), "\033[1;" "37m" "%s:%" 
# 210 "src/diagnostics.c" 3 4
 "u" 
# 210 "src/diagnostics.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "freeing %zu diagnostics: %p" "\n", "src/diagnostics.c", 210, array_length (self->diagns), ((void *)((uintptr_t)self & 0xFFFFFFFF)))
                                                            ;
