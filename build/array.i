...
{
  if (!(self->length == self->capacity)) { fprintf ((
# 26 "src/array.c" 3 4
 stderr
# 26 "src/array.c"
 ), "\033[1;" "37m" "%s:%" 
# 26 "src/array.c" 3 4
 "u" 
# 26 "src/array.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "\033[1;" "37m" "Assertion failed: " "\033[0m" "%s" "\n", "src/array.c", 26, "self->length == self->capacity"); { fprintf ((
# 26 "src/array.c" 3 4
 stderr
# 26 "src/array.c"
 ), "\033[1;" "37m" "%s:%" 
# 26 "src/array.c" 3 4
 "u" 
# 26 "src/array.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "Expected array length to be at capacity" "\n", "src/array.c", 26); exit (
# 26 "src/array.c" 3 4
 1
# 26 "src/array.c"
 ); }; };
  self->data = __chk_realloc_impl (__func__, (self->data), (2 * self->capacity * (sizeof (void*))));
  fprintf ((
# 28 "src/array.c" 3 4
 stdout
# 28 "src/array.c"
...
# 28 "src/array.c" 3 4
 "u" 
# 28 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "resized array %p from %zu bytes to %zu bytes" "\n", "src/array.c", 28, ((void *)((uintptr_t)self & 0xFFFFFFFF)), (sizeof (void*)) * self->capacity, 2 * (sizeof (void*)) * self->capacity)
                                                                                           ;
  self->capacity *= 2;
}
  ...
  {
    if (!(self->length <= self->capacity / 2)) { fprintf ((
# 37 "src/array.c" 3 4
   stderr
# 37 "src/array.c"
   ), "\033[1;" "37m" "%s:%" 
# 37 "src/array.c" 3 4
   "u" 
# 37 "src/array.c"
   "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "\033[1;" "37m" "Assertion failed: " "\033[0m" "%s" "\n", "src/array.c", 37, "self->length <= self->capacity / 2"); { fprintf ((
# 37 "src/array.c" 3 4
   stderr
# 37 "src/array.c"
   ), "\033[1;" "37m" "%s:%" 
# 37 "src/array.c" 3 4
   "u" 
# 37 "src/array.c"
   "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "Expected array length to be less than half its capacity" "\n", "src/array.c", 37); exit (
# 37 "src/array.c" 3 4
   1
# 37 "src/array.c"
   ); }; }
                                                                          ;
    self->data = __chk_realloc_impl (__func__, (self->data), (self->capacity * (sizeof (void*)) / 2));
    fprintf ((
# 40 "src/array.c" 3 4
   stdout
# 40 "src/array.c"
...
# 40 "src/array.c" 3 4
   "u" 
# 40 "src/array.c"
   "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "downsized array %p from %zu bytes to %zu bytes" "\n", "src/array.c", 40, ((void *)((uintptr_t)self & 0xFFFFFFFF)), (sizeof (void*)) * self->capacity, (sizeof (void*)) * self->capacity / 2)
...
# 52 "src/array.c" 3 4
 "u" 
# 52 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "creating unsized array" "\n", "src/array.c", 52);
  return array_new_sized ((32));
}

array_t
array_new_sized (size_t size)
{
  array_t array = __chk_calloc_impl (__func__, (1), (sizeof (*(array_t)
# 59 "src/array.c" 3 4
                 ((void *)0)
# 59 "src/array.c"
                 )));
  array->data = __chk_calloc_impl (__func__, (size), ((sizeof (void*))));
  fprintf ((
# 61 "src/array.c" 3 4
 stdout
# 61 "src/array.c"
...
# 61 "src/array.c" 3 4
 "u" 
# 61 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "new array %p, member capacity: %zu bytes" "\n", "src/array.c", 61, ((void *)((uintptr_t)array & 0xFFFFFFFF)), size * (sizeof (void*)))
                                                  ;
  array->capacity = size;
  return array;
}
...
array_insert (array_t self, size_t idx, void* item)
{
  ...
  memmove (&self->data[1 + idx], &self->data[idx], (sizeof (void*)) * (self->length - idx));
  self->data[idx] = item;
  self->length++;
  fprintf ((
# 80 "src/array.c" 3 4
...
# 80 "src/array.c" 3 4
 "u" 
# 80 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "inserted to array %p at index %zu: element %p" "\n", "src/array.c", 80, ((void *)((uintptr_t)self & 0xFFFFFFFF)), idx, item)
                                          ;
  return item;
}
...
# 88 "src/array.c" 3 4
 "u" 
# 88 "src/array.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "\033[1;" "37m" "Assertion failed: " "\033[0m" "%s" "\n", "src/array.c", 88, "self->length > 0"); { fprintf ((
# 88 "src/array.c" 3 4
 stderr
# 88 "src/array.c"
 ), "\033[1;" "37m" "%s:%" 
# 88 "src/array.c" 3 4
 "u" 
# 88 "src/array.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "Array must be non-empty" "\n", "src/array.c", 88); exit (
# 88 "src/array.c" 3 4
 1
# 88 "src/array.c"
 ); }; };
  if (idx >= self->length - 1)
    {
      __extension__ __auto_type ret = self->data[--self->length];
      array_impl_downsize (self);
      return ret;
    }
  __extension__ __auto_type ret = self->data[idx];
  memmove (&self->data[idx], &self->data[1 + idx], (sizeof (void*)) * (self->length - idx - 1));
  fprintf ((
# 97 "src/array.c" 3 4
 stdout
# 97 "src/array.c"
...
# 97 "src/array.c" 3 4
 "u" 
# 97 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "removed from array %p at index %zu: element %p" "\n", "src/array.c", 97, ((void *)((uintptr_t)self & 0xFFFFFFFF)), idx, ret)
                                         ;
  self->length--;
  array_impl_downsize (self);
  return ret;
...
# 107 "src/array.c" 3 4
 "u" 
# 107 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "popping from array %p" "\n", "src/array.c", 107, ((void *)((uintptr_t)self & 0xFFFFFFFF)));
...
# 115 "src/array.c" 3 4
 "u" 
# 115 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "appended to array %p: element at %p" "\n", "src/array.c", 115, ((void *)((uintptr_t)self & 0xFFFFFFFF)), item);
  return item;
}
...
# 122 "src/array.c" 3 4
 "u" 
# 122 "src/array.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "\033[1;" "37m" "Assertion failed: " "\033[0m" "%s" "\n", "src/array.c", 122, "idx < self->length"); { fprintf ((
# 122 "src/array.c" 3 4
 stderr
# 122 "src/array.c"
 ), "\033[1;" "37m" "%s:%" 
# 122 "src/array.c" 3 4
 "u" 
# 122 "src/array.c"
 "\033[0m" ": " "\033[1;" "31m" "error: " "\033[0m" "Tried to read index %zu of array with length %zu" "\n", "src/array.c", 122, idx, self->length); exit (
# 122 "src/array.c" 3 4
 1
# 122 "src/array.c"
 ); }; }
...
# 124 "src/array.c" 3 4
 "u" 
# 124 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "getting element of array %p at index %zu" "\n", "src/array.c", 124, ((void *)((uintptr_t)self & 0xFFFFFFFF)), idx);
...
# 137 "src/array.c" 3 4
 "u" 
# 137 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "freeing array %p, user provided callback: %p" "\n", "src/array.c", 137, ((void *)((uintptr_t)self & 0xFFFFFFFF)), (void*)&cb_free)
                                                ;
  if (cb_free == 
# 139 "src/array.c" 3 4
                ((void *)0)
# 139 "src/array.c"
    ...
    goto no_callback;
  void* item; for (size_t i = 0; i < array_length (self) && (item = array_get (self, i)); ++i)
    cb_free (item);
no_callback:
  array_free (self);
}
...
# 150 "src/array.c" 3 4
 "u" 
# 150 "src/array.c"
 "\033[0m" ": " "\033[1;" "36m" "minutiae: " "\033[0m" "freeing array %p" "\n", "src/array.c", 150, ((void *)((uintptr_t)self & 0xFFFFFFFF)));
  __chk_free_impl (__func__, self->data);
