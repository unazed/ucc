...
# 4 "include/stdio-ext.h" 2


# 5 "include/stdio-ext.h"
...
{
  fseek (stream, lookahead, 
# 9 "src/stdio-ext.c" 3 4
                           1
# 9 "src/stdio-ext.c"
                                   );
  int c = fgetc (stream);
