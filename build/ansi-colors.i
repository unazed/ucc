...
# 2 "src/ansi-colors.c" 2


# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/13/include/stdarg.h" 1 3 4
# 5 "src/ansi-colors.c" 2
...
# 11 "src/ansi-colors.c" 3 4
 __builtin_va_start(
# 11 "src/ansi-colors.c"
 args
# 11 "src/ansi-colors.c" 3 4
 ,
# 11 "src/ansi-colors.c"
...
# 16 "src/ansi-colors.c" 3 4
 __builtin_va_end(
# 16 "src/ansi-colors.c"
 args
# 16 "src/ansi-colors.c" 3 4
 )
# 16 "src/ansi-colors.c"
...
# 24 "src/ansi-colors.c" 3 4
 __builtin_va_start(
# 24 "src/ansi-colors.c"
 args
# 24 "src/ansi-colors.c" 3 4
 ,
# 24 "src/ansi-colors.c"
...
# 24 "src/ansi-colors.c"
                     ;
  cfprintf (
# 25 "src/ansi-colors.c" 3 4
           stdout
# 25 "src/ansi-colors.c"
                 , ccode, fmt, args);
  
# 26 "src/ansi-colors.c" 3 4
 __builtin_va_end(
# 26 "src/ansi-colors.c"
 args
# 26 "src/ansi-colors.c" 3 4
 )
# 26 "src/ansi-colors.c"
